from customtkinter import CTkScrollableFrame, CTkCheckBox, CTk, CTkButton
...
class App(CTk):
    def __init__(self):
        ...
        self.scrollable_checkbox_frame = VerticalScrollableFrame(self, title="Values", values=values)
